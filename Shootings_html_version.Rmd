...
timeline_chart <- ggplot(data = victims_per_date_2018_2019, aes(x = date, y = 0)) +
  ...
  geom_text(data = subset(victims_per_date_2018_2019, date == "2018-01-28" | date == "2019-02-15"), aes(label = date), size = 4, color = "#666666", hjust=-0.3, vjust=-0.3, angle=65)#+
 # geom_label_repel(data = subset(victims_per_date_2018_2019, victims > 0), 
#                 aes(label = date, fill = "#4cabab"), 
 #                  color = "#666666", 
  #                 size = 3.5)
