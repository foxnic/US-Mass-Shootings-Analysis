...
timeline_chart <- ggplot(data = victims_per_date, aes(x = date, y = 0)) +
  ...
  geom_text(data = subset(victims_per_date, date == "2016-02-20" | date == "2019-02-15"), 
  ...
  geom_segment(aes(x = as.Date("2017-10-01"), y = 0.006, xend = as.Date("2017-11-01"), yend = 0.035), 
               colour = "gray", size=0.5)+
  geom_label(aes(x = as.Date("2016-06-12"), y = 0.05, label = "Orlando nightclub massacre\n12th June 2016.\n102 victims."), 
             hjust = 0, vjust = 0.5, lineheight = 0.8,
             colour = "#FFFFFF", fill = "#dd5202", label.size = NA, family="Helvetica", size = 4)+ 
  geom_segment(aes(x = as.Date("2016-06-12"), y = 0.006, xend = as.Date("2016-07-12"), yend = 0.035), 
               colour = "gray", size=0.5)
