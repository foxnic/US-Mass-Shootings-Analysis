...
my_line_plot <- ggplot(data=shootings_per_year, aes(x=year, y=shootings, group=1)) +
  ...
  theme(
    ...
    axis.text.x = element_text(colour = "#666666", size = 16, angle = 90, vjust = 0.5),
    axis.ticks = element_blank(),
    axis.title = element_text(colour = "#666666", size = 22),
...
timeline_chart <- ggplot(data = victims_per_date, aes(x = date, y = 0)) +
  ...
  geom_segment(aes(x = as.Date("2016-06-12"), y = 0.007, xend = as.Date("2016-03-30"), yend = 0.0375), 
    ...
    geom_label(aes(x = as.Date("2016-06-06"), y = -0.05, label = "2016"), 
             hjust = 0, vjust = -0.5, lineheight = 0.8,
             colour = "#666666", fill = "white", label.size = NA, family="Helvetica", size = 4)+ 
  ...
  geom_segment(aes(x = as.Date("2018-01-01"), y = 0.03, xend = as.Date("2018-01-01"), yend = -0.03), 
               colour = "gray", size=0.5)+
    geom_label(aes(x = as.Date("2019-02-15"), y = -0.05, label = "2019"), 
             hjust = 0, vjust = -0.5, lineheight = 0.8,
             colour = "#666666", fill = "white", label.size = NA, family="Helvetica", size = 4)+ 
...
heatmap_decade_state <- ggplot(shootings_per_decade_state, aes(decade, state)) + 
  ...
  theme(
    ...
    axis.ticks = element_blank(),
    axis.title.y = element_text(colour = "#666666", size = 22),
    axis.title.x = element_text(colour = "#666666", size = 22),
...
lollipop_race <- ggplot(shootings_per_race, aes(y=shootings, x=reorder(race, -shootings))) +
  ...
  geom_text(aes(label=shootings),hjust=0.5, vjust=0.5, color = "#FFFFFF", size = 10) +
  theme(
    axis.text.y = element_blank(),
    axis.text.x = element_text(colour = "#666666", size = 22),
    axis.ticks = element_blank(),
...
semi_auto_waffle <- waffle(c('Yes'=65, 'No'=35), rows = 4, colors = c('Yes'= colour_palette[20], 'No'=colour_palette[96]))
...
# Create a waffle chart
multiple_weapons_waffle <- waffle(c('Yes'=53, 'No'=47), rows = 4, colors = c('Yes'= colour_palette[30], 'No'=colour_palette[70]))
