...
timeline_chart <- ggplot(data = victims_per_date, aes(x = date, y = 0)) +
  ...
  geom_label(aes(x = as.Date("2017-11-30"), y = 0.06, label = "Texas First Baptist Church massacre\n5th Nov 2017.\n46 victims."), 
  ...
  geom_label(aes(x = as.Date("2017-02-15"), y = 0.06, label = "Las Vegas Strip massacre\n1st Oct 2017.\n604 victims."), 
             hjust = 0, vjust = 0.5, lineheight = 0.8,
             colour = "#FFFFFF", fill = "#dd5202", label.size = NA, family="Helvetica", size = 4)+ 
  geom_segment(aes(x = as.Date("2017-10-01"), y = 0.007, xend = as.Date("2017-07-15"), yend = 0.0375), 
               colour = "#dd5202", size=0.5)+
  geom_label(aes(x = as.Date("2016-03-12"), y = 0.06, label = "Orlando nightclub massacre\n12th June 2016.\n102 victims."), 
             hjust = 0, vjust = 0.5, lineheight = 0.8,
             colour = "#FFFFFF", fill = "#dd5202", label.size = NA, family="Helvetica", size = 4)+ 
  geom_segment(aes(x = as.Date("2016-06-12"), y = 0.007, xend = as.Date("2016-04-30"), yend = 0.0375), 
               colour = "#dd5202", size=0.5)+
