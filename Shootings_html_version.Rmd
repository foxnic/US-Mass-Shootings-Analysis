...
# Create a bubble chart
bubble_year_multi <- ggplot(shootings_per_year_multi, aes(x=Year, y=Num_Shootings, color = Multiple_Weapons_Used)) +
  geom_point(alpha=0.9, size = 5)+
...
# Create a bubble chart
bubble_year_prior <- ggplot(shootings_per_year_prior, aes(x=Year, y=Num_Shootings, color = Prior_Signs_Of_Mental_Health_Issues)) +
  geom_point(alpha=0.9, size = 5)+
...
# Create a bubble chart
bubble_year_legally <- ggplot(shootings_per_year_legally, aes(x=Year, y=Num_Shootings, color = Weapons_Obtained_Legally)) +
  geom_point(alpha=0.9, size = 5)+
...
# Create a bubble chart
bubble_year_loc_type <- ggplot(shootings_per_year_loc_type, aes(x=Year, y=Num_Shootings, color = Location_Type)) +
  geom_point(alpha=0.9, size = 5)+
