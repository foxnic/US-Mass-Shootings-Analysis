...
timeline_chart <- ggplot(data = victims_per_date, aes(x = date, y = 0)) +
  ...
  geom_label(aes(x = as.Date("2017-10-01"), y = 0.06, label = "Las Vegas Strip massacre\n1st Oct 2017.\n604 victims."), 
             hjust = 0, vjust = 0.5, lineheight = 0.8,
             colour = "#FFFFFF", fill = "#dd5202", label.size = NA, family="Helvetica", size = 4)+ 
  geom_segment(aes(x = as.Date("2017-10-01"), y = 0.007, xend = as.Date("2017-11-01"), yend = 0.0375), 
               colour = "#dd5202", size=0.5)+
  geom_label(aes(x = as.Date("2016-06-12"), y = 0.06, label = "Orlando nightclub massacre\n12th June 2016.\n102 victims."), 
             hjust = 0, vjust = 0.5, lineheight = 0.8,
             colour = "#FFFFFF", fill = "#dd5202", label.size = NA, family="Helvetica", size = 4)+ 
  geom_segment(aes(x = as.Date("2016-06-12"), y = 0.007, xend = as.Date("2016-07-12"), yend = 0.0375), 
               colour = "#dd5202", size=0.5)+
    geom_label(aes(x = as.Date("2016-07-01"), y = -0.05, label = "2016"), 
             hjust = 0, vjust = -0.5, lineheight = 0.8,
  ...
  geom_segment(aes(x = as.Date("2016-01-01"), y = 0.03, xend = as.Date("2016-01-01"), yend = -0.03), 
    ...
    geom_label(aes(x = as.Date("2017-07-01"), y = -0.05, label = "2017"), 
             hjust = 0, vjust = -0.5, lineheight = 0.8,
             colour = "#666666", fill = "white", label.size = NA, family="Helvetica", size = 4)+ 
  geom_segment(aes(x = as.Date("2017-01-01"), y = 0.03, xend = as.Date("2017-01-01"), yend = -0.03), 
               colour = "gray", size=0.5)+
    geom_label(aes(x = as.Date("2018-07-01"), y = -0.05, label = "2018"), 
             hjust = 0, vjust = -0.5, lineheight = 0.8,
             colour = "#666666", fill = "white", label.size = NA, family="Helvetica", size = 4)+ 
