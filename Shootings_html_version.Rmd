...
Arkansas is the only state to have mass shootings in which the shooter did **not** have any prior signs of mental health issues, but Arizona has only had **1** mass shooting and the shooter was only **11 years old**. 
