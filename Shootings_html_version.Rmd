...
packages <- list("tidyverse", "operators", "knitr", "sf", "usmap", "waffle", "treemapify", "gganimate", "tweenr", "gifski", "png", "viridis")
...
cleansed_data <- cleansed_data %>%
  mutate (gender = factor(gender, levels = c("M", 
                                             "Male", 
                                             "F", 
                                             "Female", 
                                             "Male & Female"),
...
# MG: dare say there's some clever stuff to be had with regex or %in% here if using cases...
cleansed_data <- cleansed_data %>%
  mutate(race =tolower(race)) %>% # MG: added tolower to reduce the number of cases 
