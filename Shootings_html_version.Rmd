...
plot_state_map_victims <- plot_usmap(data = victims_by_state, values = "victims", regions = "states", labels = TRUE) +
  ...
  theme(legend.position = "right", plot.margin=unit(c(1.5,0,1.5,0),"cm"))
...
# Create a waffle chart
multiple_weapons_waffle <- waffle(c('Yes'=53, 'No'=47), rows = 4, colors = c('Yes'= colour_palette[40], 'No'=colour_palette[70]))
